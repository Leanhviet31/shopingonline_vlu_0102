...
// myprofile - update customer info
...
router.get('/products/category/:cid', async function (req, res) {
    try {
        ...
        console.error('Error in /products/category/:cid:', error);
        res.status(500).json({ message: 'Internal Server Error' });
    }
});
...
router.get('/products/search/:keyword', async function (req, res) {
    try {
        ...
        console.error('Error in /products/search/:keyword:', error);
        res.status(500).json({ message: 'Internal Server Error' });
    }
});

// product - details by ID (Route này PHẢI nằm cuối cùng)
